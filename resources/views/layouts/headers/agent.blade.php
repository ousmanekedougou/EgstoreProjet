    ...
    <ul class="navbar-nav navbar-nav-icons flex-row">
      ...
      <li class="nav-item">
        <a class="nav-link px-2 icon-indicator icon-indicator-primary" href="{{ route('magasin.panier.index') }}" role="button">
          <span class="text-body-tertiary" data-feather="shopping-cart"></span>
          ...
          <div class="card position-relative border-0">
            ...
            <div class="overflow-auto scrollbar" style="height: 3rem;">
              <ul class="nav d-flex flex-column mb-2 pb-1">
                <li class="nav-item"><a class="nav-link px-3" href="{{ route('agent.profile.index') }}"> <span class="me-2 text-body" data-feather="user"></span><span>Votre profile</span></a></li>
              </ul>
            </div>
