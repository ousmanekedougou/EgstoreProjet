        ...
        <div class="col-auto">
          ...
          <div class="d-sm-flex flex-between-center mb-3">
            <p class="text-body-secondary lh-sm mb-0 mt-2 mt-sm-0">
              Magasin : <a class="fw-bold" href="#!" style="margin-right: 15px;">@if($supplyOrder->supply->magasin_id != null) {{ $supplyOrder->supply->magasin->name }} @else {{ $supplyOrder->supply->name }} @endif</a>
              Email : <a class="fw-bold" href="#!" style="margin-right: 15px;">@if($supplyOrder->supply->magasin_id != null) {{ $supplyOrder->supply->magasin->email }} @else {{ $supplyOrder->supply->email }} @endif</a>
              Téléphone : <a class="fw-bold" href="#!">@if($supplyOrder->supply->magasin_id != null) {{ $supplyOrder->supply->magasin->phone }} @else {{ $supplyOrder->supply->phone }} @endif</a>
            </p>
          </div>
        </div>
      </div>
